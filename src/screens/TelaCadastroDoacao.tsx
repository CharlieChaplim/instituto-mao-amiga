...
export function TelaCadastroDoacao({ navigation }: Props) {
  ...
  useEffect(() => {
    async function recuperarUltimaDoacao() {
      try {
        ...
        Alert.alert('Erro', 'Não foi possível recuperar a última doação salva.');
      }
    }
  ...
  async function criarDoacao() {
    ...
    try {
      ...
      Alert.alert('Doação criada', 'Os dados da doação foram salvos neste aparelho.', [
        {
          text: 'OK',
      ...
      Alert.alert('Erro', 'Não foi possível salvar os dados da doação.');
    }
  }
    ...
    <SafeAreaView style={styles.safeArea} edges={['bottom', 'left', 'right']}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.rotulo}>Nome do doador</Text>
          <TextInput
            style={styles.input}
            value={nome}
          ...
          <Text style={styles.rotulo}>Item para doação</Text>
          <TextInput
            style={styles.input}
            value={item}
          ...
          <TouchableOpacity style={styles.botao} onPress={criarDoacao}>
